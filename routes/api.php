...
Route::prefix('pendaftaran')->group(function () {
    ...
    Route::get('/{id_daftar}', [PendaftaranController::class, 'show']);
    Route::put('/update/{id_daftar}', [PendaftaranController::class, 'update']);
    Route::delete('/delete/{id_daftar}', [PendaftaranController::class, 'destroy']);
});

Route::prefix('pembimbing')->group(function () {
    Route::get('/', [PembimbingController::class, 'index']);
    Route::post('/store', [PembimbingController::class, 'store']);
    Route::get('/{id_pembimbing}', [PembimbingController::class, 'show']);
    Route::put('/update/{id_pembimbing}', [PembimbingController::class, 'update']);
    Route::delete('/delete/{id_pembimbing}', [PembimbingController::class, 'destroy']);
});

Route::prefix('logbook')->group(function () {
    Route::get('/', [LogbookController::class, 'index']);
    Route::post('/store', [LogbookController::class, 'store']);
    Route::get('/{id_logbook}', [LogbookController::class, 'show']);
    Route::put('/update/{id_logbook}', [LogbookController::class, 'update']);
    Route::delete('/delete/{id_logbook}', [LogbookController::class, 'destroy']);
});
...
Route::prefix('penilaian')->group(function () {
    ...
    Route::get('/{id_nilai}', [PenilaianController::class, 'show']);
    Route::put('/update/{id_nilai}', [PenilaianController::class, 'update']);
    Route::delete('/delete/{id_nilai}', [PenilaianController::class, 'destroy']);
});

Route::prefix('komponennilai')->group(function () {
    Route::get('/', [KomponenNilaiController::class, 'index']);
    Route::post('/store', [KomponenNilaiController::class, 'store']);
    Route::get('/{id_komponen}', [KomponenNilaiController::class, 'show']);
    Route::put('/update/{id_komponen}', [KomponenNilaiController::class, 'update']);
    Route::delete('/delete/{id_komponen}', [KomponenNilaiController::class, 'destroy']);
});
...
Route::prefix('usulankonversi')->group(function () {
    ...
    Route::get('/{id_usulan}', [UsulanKonversiController::class, 'show']);
    Route::put('/update/{id_usulan}', [UsulanKonversiController::class, 'update']);
    Route::delete('/delete/{id_usulan}', [UsulanKonversiController::class, 'destroy']);
});
