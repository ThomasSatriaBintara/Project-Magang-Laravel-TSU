...
@section('content')
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        <div>
            ...
            <div class="flex flex-wrap items-center gap-4 mt-1">
                ...
                @else
                    <span class="fade-up delay-200 bg-green-100 text-green-700 px-4 py-0.5 rounded-full text-sm font-bold">Aktif</span>
                @endif
        ...
        @elseif($isDosen || $isAdmin)
            <button class="fade-up delay-300 bg-gray-300 text-gray-500 font-bold py-3 px-8 rounded-full flex items-center gap-2 shadow-none cursor-not-allowed" disabled title="Hanya untuk Mahasiswa">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="fade-up delay-400 grid grid-cols-1 lg:grid-cols-5 gap-6 mb-6">
        ...
        <div class="lg:col-span-2 border border-gray-300 bg-white rounded-2xl p-5 flex flex-col items-center justify-center shadow-sm text-center">
            <h3 class="font-bold text-black text-lg mb-1">Jumlah Pendaftar</h3>
            <span class="text-4xl font-extrabold text-red-600">31</span>
        </div>
    </div>
